...
if __name__ == "__main__":
    ...
    p_gt.add_argument("--gt_pkl",    default=os.path.join(_THIS_DIR, '..', 'data', 'ntu60_3danno.pkl'))
    p_gt.add_argument("--out_pkl",   default=os.path.join(_THIS_DIR, 'data', 'action', 'ntu60_gt_coco17.pkl'))
