...
def main():
    config_path = "configs/action/MB_ft_NTU60_xsub.yaml"
    if not os.path.exists(config_path): config_path = "configs/action/MB_train_NTU60_xsub.yaml"
    ...
    checkpoint_path = "checkpoint/action/best_epoch.bin"
