...
Usage:
    python visualize_projection.py \
        --gt_pkl /workspace/clone_model/data/ntu60_3danno.pkl \
        --sample_idx 240 \
        --frame 30 \
        --out_dir vis_output
"""
...
def parse_args():
    ...
    parser.add_argument("--gt_pkl",     default="/workspace/clone_model/data/ntu60_3danno.pkl")
    ...
    parser.add_argument("--out_dir",    default="/workspace/clone_model/MotionBERT/vis_output")
